...
function ProjectsSection() {
  return (
    <section className="min-h-screen px-10 py-20 md:px-16 lg:px-32 bg-richBlack">
      ...
      <div>
        <h2 className="text-2xl md:text-xl font-chivo text-argBlue py-5">More projects</h2>
