...
function ProjectsSection() {
  return (
    <section className="min-h-screen px-10 py-10 lg:px-28 lg:py-28 bg-richBlack">
      ...
      <div>
        <h3 className="font-chivo text-2xl md:text-3xl text-argBlue py-5">Featured projects</h3>
      ...
      <div>
        <h3 className="text-2xl md:text-3xl font-chivo text-argBlue py-5">More projects</h3>
